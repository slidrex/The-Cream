...
namespace Assets.Scripts.GameProgress
{
    internal static class PersistentData
    {
        ...
        public static HashSet<CharacterDatabaseModel.CharacterID> UnlockedCharacters = new () { CharacterDatabaseModel.CharacterID.KNIGHT, CharacterDatabaseModel.CharacterID.LIGHT_EATER, CharacterDatabaseModel.CharacterID.THORS };
    }
}
